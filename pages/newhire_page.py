    ...
    return dcc.Loading(dbc.Container([
        ...
        dbc.Card(dbc.CardBody([
            dbc.Row([
                ...
                dbc.Col(dcc.Loading(html.Span(id="hire-save-msg", className="text-success"), className="loading-block"), md=3),
            ...
            html.Hr(),
            dcc.Loading(dcc.Graph(id="fig-hire", style={"height":"280px"}, config={"displayModeBar": False}), className="loading-block"),
        ])),
