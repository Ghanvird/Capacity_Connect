            ...
            dbc.Tabs(id="bud-tabs", active_tab="bud-voice", children=[
                ...
                dbc.Tab(label="Voice budget", tab_id="bud-voice", children=[
                    ...
                    dbc.Row([
                        ...
                        dbc.Col(dcc.Loading(html.Span(id="msg-save-bud-voice", className="text-success"), className="loading-block"), md=9),
                    ], className="mt-2"),
                ]),
                ...
                dbc.Tab(label="Back Office budget", tab_id="bud-bo", children=[
                    ...
                    dbc.Row([
                        ...
                        dbc.Col(dcc.Loading(html.Span(id="msg-save-bud-bo", className="text-success"), className="loading-block"), md=9),
                    ], className="mt-2"),
                ]),
            ])
        ])),        
