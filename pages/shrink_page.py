        ...
        dbc.Tabs(id="shr-tabs", active_tab="tab-shrink", children=[
            dbc.Tab(label="Shrinkage", tab_id="tab-shrink", children=[
                ...
                dbc.Tabs(id="shr-inner-tabs", active_tab="inner-manual", children=[
                    dbc.Tab(label="Weekly Shrink %", tab_id="inner-manual", children=[
                        ...
                        dcc.Loading(dcc.Graph(id="fig-shrink", style={"height":"280px"}, config={"displayModeBar": False}), className="loading-block"),
                    ]),
                    ...
                    dbc.Tab(label="Back Office — Shrinkage (Raw)", tab_id="inner-bo", children=[
                        ...
                        dcc.Loading(dash_table.DataTable(id="tbl-shr-bo-raw", page_size=8, style_table={"overflowX":"auto"},
                                             style_as_list_view=True, style_header={"textTransform":"none"}), className="loading-block"),
                        html.H6("Daily Summary (derived)"),
                        dcc.Loading(dash_table.DataTable(id="tbl-shr-bo-sum", page_size=8, style_table={"overflowX":"auto"},
                                             style_as_list_view=True, style_header={"textTransform":"none"}), className="loading-block"),
                        dcc.Loading(html.Div(id="bo-shr-save-msg", className="text-success mt-2"), className="loading-block"),
                    ]),
                    ...
                    dbc.Tab(label="Voice — Shrinkage (Raw)", tab_id="inner-voice", children=[
                        ...
                        html.H6("Uploaded (normalized)"),
                        dcc.Loading(dash_table.DataTable(id="tbl-shr-voice-raw", page_size=8, style_table={"overflowX":"auto"},
                                             style_as_list_view=True, style_header={"textTransform":"none"}), className="loading-block"),
                        html.H6("Daily Summary (derived)"),
                        dcc.Loading(dash_table.DataTable(id="tbl-shr-voice-sum", page_size=8, style_table={"overflowX":"auto"},
                                             style_as_list_view=True, style_header={"textTransform":"none"}), className="loading-block"),
                        dcc.Loading(html.Div(id="voice-shr-save-msg", className="text-success mt-2"), className="loading-block"),
                    ]),
                ])
            ]),
            ...
            dbc.Tab(label="Attrition", tab_id="tab-attr", children=[
                dbc.Row([
                    ...
                    dbc.Col(dcc.Loading(html.Span(id="attr-save-msg", className="text-success"), className="loading-block"), md=3),
                ...
                dcc.Loading(dcc.Graph(id="fig-attr", style={"height":"280px"}, config={"displayModeBar": False}), className="loading-block"),
            ]),
        ])
