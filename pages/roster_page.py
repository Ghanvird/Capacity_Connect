    ...
    return dcc.Loading(dbc.Container([
        ...
        dbc.Card(dbc.CardBody([
            ...
            dbc.Row([
                ...
                dbc.Col(dcc.Loading(html.Span(id="roster-save-msg", className="text-success"), className="loading-block"), md=4),
            ], className="my-2"),
            ...
            dcc.Loading(html.Div(id="roster-wide-msg", className="text-muted mt-1"), className="loading-block"),
        ]), className="mb-3"),
        ...
        dbc.Card(dbc.CardBody([
            ...
            dcc.Loading(html.Div(id="bulk-clear-msg", className="text-muted small mt-2"), className="loading-block")
        ]), className="mb-3"),
