...
def page_default_settings():
    ...
    return dcc.Loading(dbc.Container([
        header_bar(),
        ...
        dbc.Card(dbc.CardBody([
            ...
            dbc.Tabs(id="vol-tabs", children=[
                ...
                dcc.Tab(label="Voice", value="tab-voice", children=[
                    ...
                    dcc.Loading(dash_table.DataTable(id="tbl-voice-forecast", page_size=10,
                        style_table={"overflowX":"auto"},
                        style_as_list_view=True, style_header={"textTransform":"none"}
                    ), className="loading-block"),
                    dcc.Loading(html.Div(id="voice-forecast-msg", className="text-success mt-1"), className="loading-block"),
                    ...
                    dcc.Loading(dash_table.DataTable(id="tbl-voice-actual", page_size=10,
                        style_table={"overflowX":"auto"},
                        style_as_list_view=True, style_header={"textTransform":"none"}
                    ), className="loading-block"),
                    dcc.Loading(html.Div(id="voice-actual-msg", className="text-success mt-1"), className="loading-block"),
                ]),
                ...
                dcc.Tab(label="Back Office", value="tab-bo", children=[
                    ...
                    dcc.Loading(dash_table.DataTable(id="tbl-bo-forecast", page_size=10,
                        style_table={"overflowX":"auto"},
                        style_as_list_view=True, style_header={"textTransform":"none"}
                    ), className="loading-block"),
                    dcc.Loading(html.Div(id="bo-forecast-msg", className="text-success mt-1"), className="loading-block"),
                    ...
                    dcc.Loading(dash_table.DataTable(id="tbl-bo-actual", page_size=10,
                        style_table={"overflowX":"auto"},
                        style_as_list_view=True, style_header={"textTransform":"none"}
                    ), className="loading-block"),
                    dcc.Loading(html.Div(id="bo-actual-msg", className="text-success mt-1"), className="loading-block"),
                ]),
                ...
                dcc.Tab(label="Chat", value="tab-chat", children=[
                    ...
                    dcc.Loading(dash_table.DataTable(id="tbl-chat-forecast", page_size=10,
                        style_table={"overflowX":"auto"},
                        style_as_list_view=True, style_header={"textTransform":"none"}
                    ), className="loading-block"),
                    dcc.Loading(html.Div(id="chat-forecast-msg", className="text-success mt-1"), className="loading-block"),
                    ...
                    dcc.Loading(dash_table.DataTable(id="tbl-chat-actual", page_size=10,
                        style_table={"overflowX":"auto"},
                        style_as_list_view=True, style_header={"textTransform":"none"}
                    ), className="loading-block"),
                    dcc.Loading(html.Div(id="chat-actual-msg", className="text-success mt-1"), className="loading-block"),
                ]),
                ...
                dcc.Tab(label="Outbound", value="tab-ob", children=[
                    ...
                    dcc.Loading(dash_table.DataTable(id="tbl-ob-forecast", page_size=10,
                        style_table={"overflowX":"auto"},
                        style_as_list_view=True, style_header={"textTransform":"none"}
                    ), className="loading-block"),
                    dcc.Loading(html.Div(id="ob-forecast-msg", className="text-success mt-1"), className="loading-block"),
                    ...
                    dcc.Loading(dash_table.DataTable(id="tbl-ob-actual", page_size=10,
                        style_table={"overflowX":"auto"},
                        style_as_list_view=True, style_header={"textTransform":"none"}
                    ), className="loading-block"),
                    dcc.Loading(html.Div(id="ob-actual-msg", className="text-success mt-1"), className="loading-block"),
                ]),
            ])
        ]), className="mb-3"),
        ...
        dbc.Card(dbc.CardBody([
            ...
            dbc.Tabs(id="vol-tabs1", children=[
                ...
                dcc.Tab(label="Voice", value="tab-voice1", children=[
                    ...
                    dcc.Loading(dash_table.DataTable(id="tbl-voice-forecast1", page_size=10,
                        style_table={"overflowX":"auto"},
                        style_as_list_view=True, style_header={"textTransform":"none"}
                    ), className="loading-block"),
                    dcc.Loading(html.Div(id="voice-forecast-msg1", className="text-success mt-1"), className="loading-block"),
                ]),
                ...
                dcc.Tab(label="Back Office", value="tab-bo1", children=[
                    ...
                    dcc.Loading(dash_table.DataTable(id="tbl-bo-forecast1", page_size=10,
                        style_table={"overflowX":"auto"},
                        style_as_list_view=True, style_header={"textTransform":"none"}
                    ), className="loading-block"),
                    dcc.Loading(html.Div(id="bo-forecast-msg1", className="text-success mt-1"), className="loading-block"),
                ]),
                ...
                dcc.Tab(label="Chat", value="tab-chat1", children=[
                    ...
                    dcc.Loading(dash_table.DataTable(id="tbl-chat-forecast1", page_size=10,
                        style_table={"overflowX":"auto"},
                        style_as_list_view=True, style_header={"textTransform":"none"}
                    ), className="loading-block"),
                    dcc.Loading(html.Div(id="chat-forecast-msg1", className="text-success mt-1"), className="loading-block"),
                ]),
                ...
                dcc.Tab(label="Outbound", value="tab-ob1", children=[
                    ...
                    dcc.Loading(dash_table.DataTable(id="tbl-ob-forecast1", page_size=10,
                        style_table={"overflowX":"auto"},
                        style_as_list_view=True, style_header={"textTransform":"none"}
                    ), className="loading-block"),
                    dcc.Loading(html.Div(id="ob-forecast-msg1", className="text-success mt-1"), className="loading-block"),
                ]),
            ])
        ]), className="mb-3"),        
        ...
        dbc.Card(dbc.CardBody([
            ...
            dcc.Loading(html.Div(id="hc-msg", className="text-success mt-1"), className="loading-block"),
        ]), className="mb-3"),
