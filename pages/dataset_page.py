...
def page_dataset():
    ...
    return dcc.Loading(dbc.Container([
        ...
        dcc.Loading(dash_table.DataTable(id="dataset-table", page_size=12, style_table={"overflowX":"auto"}, style_as_list_view=True, style_header={"textTransform": "none"}), className="loading-block"),
        dcc.Loading(dcc.Graph(id="dataset-fig", className="mt-3"), className="loading-block"),
