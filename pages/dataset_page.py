...
def page_dataset():
    ...
    return dbc.Container([
        ...
        dash_table.DataTable(id="dataset-table", page_size=12, style_table={"overflowX":"auto"}, style_as_list_view=True, style_header={"textTransform": "none"}),
        dcc.Graph(id="dataset-fig", className="mt-3"),
    ], fluid=True)
