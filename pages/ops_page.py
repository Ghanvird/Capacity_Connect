...
def page_ops():
    ...
    return dcc.Loading(dbc.Container([
        ...
        dbc.Card(dbc.CardBody([
            dbc.Row([
                dbc.Col(dcc.Loading(dcc.Graph(id="ops-line-req-sup", config={"displayModeBar": False}), className="loading-block"), md=6),
                dbc.Col(dcc.Loading(dcc.Graph(id="ops-bar-volume", config={"displayModeBar": False}), className="loading-block"), md=6),
            ], className="g-3"),
            dbc.Row([
                dbc.Col(dcc.Loading(dcc.Graph(id="ops-pie-channel", config={"displayModeBar": False}), className="loading-block"), md=4),
                dbc.Col(dcc.Loading(dcc.Graph(id="ops-col-site", config={"displayModeBar": False}), className="loading-block"), md=4),
                dbc.Col(dcc.Loading(dcc.Graph(id="ops-waterfall-gap", config={"displayModeBar": False}), className="loading-block"), md=4),
            ], className="g-3 mb-3"),
        ])),
        ...
        dbc.Card(dbc.CardBody([
            ...
            dcc.Loading(dash_table.DataTable(id="ops-table-summary", page_size=10, style_table={"overflowX":"auto"}, style_as_list_view=True), className="loading-block")
        ]))
